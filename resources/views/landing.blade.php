...
<head>
    ...
    <meta name="description" content="Créez et gérez vos tontines en ligne. Paiement Wave & Orange Money. Accessible via smartphone ou *144#.">
        ...
        <div class="row align-items-center min-vh-hero">
            <div class="col-lg-6 hero-content">
                ...
                <p class="hero-subtitle">
                    ...
                    via smartphone ou simple téléphone, en toute transparence.
                </p>
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6 col-lg-3">
                <div class="feature-card feature-card-highlight">
                    ...
                    <h4 class="feature-title">Interface en français</h4>
                    <p class="feature-desc">
                        Une interface claire et simple, pensée pour être accessible à tous les membres du groupe.
                    </p>
                </div>
            </div>
            <div class="col-md-6 col-lg-3">
            ...
            <div class="col-lg-6">
                <div class="trust-visual">
                    <div class="trust-stat-grid">
                        ...
                        <div class="trust-stat">
                            <div class="trust-stat-value text-green">50</div>
                            <div class="trust-stat-label">Membres max par tontine</div>
                        </div>
                        <div class="trust-stat">
        ...
        <div class="row align-items-center g-5">
            ...
            <div class="col-lg-7">
                ...
                <div class="ussd-features">
                    ...
                    <div class="ussd-feature-item">
                        <span class="ussd-feature-icon">🇸🇳</span>
                        <span>Conçu pour le contexte sénégalais</span>
                    </div>
                    <div class="ussd-feature-item">
                        <span class="ussd-feature-icon">⚡</span>
    ...
    <div class="container text-center">
        <div class="cta-inner">
            ...
            <div class="cta-reassurance">
                ...
                <span><i class="fas fa-check me-1"></i>Connexion sécurisée par lien magique</span>
                <span><i class="fas fa-check me-1"></i>Wave & Orange Money intégrés</span>
            </div>
        </div>
    </div>
</section>
